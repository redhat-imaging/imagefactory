...
class TestApplicationConfiguration(unittest.TestCase):
    def setUp(self):
        ...
        self.defaults = dict(verbose=False, debug=False, foreground=False, config="/etc/imagefactory.conf", output="/tmp", qmf=False, qpidd="localhost", warehouse=None, template=None)
