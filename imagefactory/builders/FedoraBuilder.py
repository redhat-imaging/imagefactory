...
# Image actions
        ...
        def build(self):
                ...
                self.log.debug("Building for target %s with warehouse config %s" % (self.target, app_config['warehouse']))
	...
	def ec2_push_image(self, image_id, provider, credentials):
		...
		input_image_path=app_config['output_dir'] + "/"
		...
		bundle_destination=app_config['output_dir']
